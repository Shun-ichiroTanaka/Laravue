      ...
      <div class="w-full flex">
        <main class="lg:w-4/5 main-bg flex-grow py-6 px-12 rounded-lg">
            ...
            <div class="">
              ...
              <code-view>
                <iframe
                  src="https://codesandbox.io/embed/9owjzmoj24?fontsize=14&hidenavigation=1&theme=dark"
...
<script>
import HeaderProfile from  "@/components/laravue_template/object/profile/HeaderProfile";
import CodeView from  "@/components/laravue_template/object/button/CodeView";
import FooterNav from  "@/components/laravue_template/layout/footer/FooterNav";
import LeftSidebar from  "@/components/laravue_template/layout/sidebar/LeftSidebar";
